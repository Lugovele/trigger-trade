# F-004 Revised Specification Cycle 1
...
| Status | Revised candidate after Full Council Cycle 1 |
...
and closes the two blocking items identified there:

```text
F004-C02: completed-day and same-clock population eligibility
F004-C03: local 5m ATR_PCT dependency for the 5m VNM veto
```
...
CURRENT_CANDIDATE = F-004_REVISED_SPEC_CYCLE_1
```
...
- proven pre-inception absence may yield 14 through 29 eligible prior
  same-clock observations;
